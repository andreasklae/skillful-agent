...
def _create_runner(
    ...
    def use_skill(
        ...
        # List client-side functions the agent can request
    ...
    # Requests execution of a function declared by a skill that runs
    # on the client, not the agent. The SDK validates the call and
    # queues a ClientFunctionRequest for emission on the event stream.
    ...
    def call_client_function(
        ...
        # Validate function exists in skill's client_functions
        func = None
        for cf in skill.client_functions:
        ...
        # Queue the request for emission on the event stream
